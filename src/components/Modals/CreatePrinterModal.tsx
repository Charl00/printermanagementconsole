...
import { PrinterStatus } from "@/interfaces/Printer.interface";
...
export default function CreatePrinterModal({ closeModal, isOpen }: UpdatePrinterModalProps) {
  const { addPrinter } = useContext(PrinterDataContext);

  const [printerName, setPrinterName] = useState<string>("");
  const [printerIP, setPrinterIP] = useState<string>("");
  const [printerStatus, setPrinterStatus] = useState<PrinterStatus>("inactive");
